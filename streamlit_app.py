...
MODEL_OPTIONS = ["BLIP Base", "BLIP Large", "ViT GPT2"]
...
if uploaded_file:
    ...
    if st.button("Generate Caption"):
        try:
            with st.spinner("Generating caption... (first run may take time)"):
            ...
            st.error("App crashed while generating caption.")
            st.exception(e)
else:
